 ...
 *
 *1/26/2024: start fresh with pedroPathing v1.0.7 and FTCrobotController v10.2
 *
 *
 */
...
@Config
@Autonomous(name = "PP Auto_RedBasket v1.1", group = "Auto")

public class PP_Auto_RedBasket1 extends OpMode {
    int debugLevel = 499;
